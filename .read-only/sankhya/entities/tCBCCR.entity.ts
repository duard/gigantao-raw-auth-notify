...
@Index('PK_TCBCCR', ['nuperiodoctb', 'sequencia'], { unique: true })
@Index('TCBCCR_I01', ['nuperiodoctb', 'dhalter'], {})
@Entity('TCBCCR', { schema: 'SANKHYA' })
export class TcbccrEntity {
  ...
  @ManyToOne(() => TcbpctEntity, (tcbpctEntity) => tcbpctEntity.tcbccrs)
