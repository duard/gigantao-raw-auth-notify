...
@Index('PK_TCBIMPRC', ['nuperiodoctb', 'sequencia'], { unique: true })
@Index('TCBIMPRC_I01', ['nuperiodoctb', 'dhalter'], {})
@Entity('TCBIMPRC', { schema: 'SANKHYA' })
export class TcbimprcEntity {
  ...
  @ManyToOne(() => TcbpctEntity, (tcbpctEntity) => tcbpctEntity.tcbimprcs)
