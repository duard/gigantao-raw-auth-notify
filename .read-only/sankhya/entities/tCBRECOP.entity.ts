...
@Index('PK_TCBRECOP', ['nuperiodoctb', 'sequencia'], { unique: true })
@Index('TCBRECOP_I01', ['nuperiodoctb', 'dhalter'], {})
@Entity('TCBRECOP', { schema: 'SANKHYA' })
export class TcbrecopEntity {
  ...
  @ManyToOne(() => TcbpctEntity, (tcbpctEntity) => tcbpctEntity.tcbrecops)
