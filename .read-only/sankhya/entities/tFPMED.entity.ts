...
@Entity('TFPMED', { schema: 'SANKHYA' })
export class TfpmedEntity {
  ...
  @ManyToOne(() => TsiusuEntity, (tsiusuEntity) => tsiusuEntity.tfpmeds)
  @JoinColumn([{ name: 'CODUSU', referencedColumnName: 'codusu' }])
  codusu: TsiusuEntity;

  @ManyToOne(() => TfpfunEntity, (tfpfunEntity) => tfpfunEntity.tfpmeds)
  @JoinColumn([
  ...
  @ManyToOne(() => TfpeveEntity, (tfpeveEntity) => tfpeveEntity.tfpmeds)
