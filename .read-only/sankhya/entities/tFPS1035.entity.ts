...
@Index('PK_TFPS1035', ['codemp', 'dtref', 'tpamb', 'sequencia', 'chave'], {
  unique: true,
})
@Entity('TFPS1035', { schema: 'SANKHYA' })
export class Tfps1035Entity {
  ...
  @Column('varchar', { name: 'DSCCARREIRA', nullable: true, length: 100 })
  dsccarreira: string | null;
  ...
  @Column('smallint', { name: 'SITCARR', nullable: true })
  sitcarr: number | null;
