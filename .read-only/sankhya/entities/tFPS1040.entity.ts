...
@Index('PK_TFPS1040', ['codemp', 'dtref', 'tpamb', 'sequencia', 'chave'], {
  unique: true,
})
@Entity('TFPS1040', { schema: 'SANKHYA' })
export class Tfps1040Entity {
  ...
  @Column('varchar', { name: 'DSCFUNCAO', nullable: true, length: 100 })
  dscfuncao: string | null;
