...
@Entity('TFPS1210_BENEFPEN', { schema: 'SANKHYA' })
export class Tfps1210BenefpenEntity {
  ...
  @ManyToOne(
    ...
    (tfps1210DedsuspEntity) => tfps1210DedsuspEntity.tfps1210Benefpens,
    { onDelete: 'CASCADE' },
  )
  @JoinColumn([
  ...
  tfps1210Dedsusp: Tfps1210DedsuspEntity;
}
