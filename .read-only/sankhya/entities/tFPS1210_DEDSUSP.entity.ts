...
import { Tfps1210BenefpenEntity } from './tFPS1210_BENEFPEN.entity';
...
@Entity('TFPS1210_DEDSUSP', { schema: 'SANKHYA' })
export class Tfps1210DedsuspEntity {
  ...
  @OneToMany(
    () => Tfps1210BenefpenEntity,
    (tfps1210BenefpenEntity) => tfps1210BenefpenEntity.tfps1210Dedsusp,
  )
  tfps1210Benefpens: Tfps1210BenefpenEntity[];

  @ManyToOne(
    () => Tfps1210InfovaloresEntity,
    (tfps1210InfovaloresEntity) => tfps1210InfovaloresEntity.tfps1210Dedsusps,
    { onDelete: 'CASCADE' },
  )
  @JoinColumn([
