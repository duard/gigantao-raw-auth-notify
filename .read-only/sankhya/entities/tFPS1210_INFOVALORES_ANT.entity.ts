...
@Entity('TFPS1210_INFOVALORES_ANT', { schema: 'SANKHYA' })
export class Tfps1210InfovaloresAntEntity {
  ...
  @OneToMany(
    ...
    (tfps1210DedsuspAntEntity) =>
      tfps1210DedsuspAntEntity.tfps1210InfovaloresAnt,
  )
  tfps1210DedsuspAnts: Tfps1210DedsuspAntEntity[];

  @ManyToOne(
    () => Tfps1210InfoprocretAntEntity,
    (tfps1210InfoprocretAntEntity) =>
      tfps1210InfoprocretAntEntity.tfps1210InfovaloresAnts,
    { onDelete: 'CASCADE' },
  )
  @JoinColumn([
  ...
  tfps1210InfoprocretAnt: Tfps1210InfoprocretAntEntity;
}
