...
@Entity('TFPS1210_PENALIM_ANT', { schema: 'SANKHYA' })
export class Tfps1210PenalimAntEntity {
  ...
  @Column('float', { name: 'VLRDEDPENALIM', precision: 53 })
  vlrdedpenalim: number;

  @ManyToOne(
    () => Tfps1210InfoircrAntEntity,
    (tfps1210InfoircrAntEntity) =>
      tfps1210InfoircrAntEntity.tfps1210PenalimAnts,
    { onDelete: 'CASCADE' },
  )
  @JoinColumn([
