...
@Index('PK_TFPS1260', ['codemp', 'dtref', 'sequencia', 'tpamb', 'chave'], {
  unique: true,
})
@Entity('TFPS1260', { schema: 'SANKHYA' })
export class Tfps1260Entity {
  ...
  @Column('varchar', { name: 'NRINSCESTABRURAL', nullable: true, length: 15 })
  nrinscestabrural: string | null;

  @OneToMany(
    () => Tfps1260TpcomercEntity,
    (tfps1260TpcomercEntity) => tfps1260TpcomercEntity.tfps1,
  )
  tfps1260Tpcomercs: Tfps1260TpcomercEntity[];
}
