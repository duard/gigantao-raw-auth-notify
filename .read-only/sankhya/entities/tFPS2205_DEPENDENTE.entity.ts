...
import { Tfps2205Entity } from './tFPS2205.entity';

@Index(
  'PK_TFPS2205_DEPENDENTE',
  ['codemp', 'dtref', 'tpamb', 'sequencia', 'chavepai', 'chave'],
  {
    unique: true,
  },
)
@Entity('TFPS2205_DEPENDENTE', { schema: 'SANKHYA' })
export class Tfps2205DependenteEntity {
  ...
  @Column('char', { name: 'SEXODEP', nullable: true, length: 1 })
  sexodep: string | null;
  ...
  @ManyToOne(
    () => Tfps2205Entity,
    (tfps2205Entity) => tfps2205Entity.tfps2205Dependentes,
    {
      onDelete: 'CASCADE',
    },
  )
