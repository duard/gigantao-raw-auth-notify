...
@Entity('TFPS2210_AC', { schema: 'SANKHYA' })
export class Tfps2210AcEntity {
  ...
  @Column('int', { name: 'CODAGNTCAUSADOR', nullable: true })
  codagntcausador: number | null;

  @ManyToOne(
    () => Tfps2210Entity,
    (tfps2210Entity) => tfps2210Entity.tfps2210Acs,
    {
      onDelete: 'CASCADE',
    },
  )
