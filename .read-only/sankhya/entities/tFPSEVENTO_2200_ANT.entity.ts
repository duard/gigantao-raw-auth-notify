...
@Index(
  'PK_TFPSEVENTO_2200_ANT',
  ['codemp', 'dtref', 'tpamb', 'sequencia', 'chave'],
  {
    unique: true,
  },
)
@Index('TFPSEVENTO_2200_ANT_I01', ['codemp', 'sitesocial'], {})
@Entity('TFPSEVENTO_2200_ANT', { schema: 'SANKHYA' })
export class Tfpsevento_2200AntEntity {
  ...
  @Column('varchar', { name: 'JUSTCONTR', nullable: true, length: 999 })
