...
@Entity('TGFADRCSTR1410', { schema: 'SANKHYA' })
export class Tgfadrcstr1410Entity {
  ...
  @ManyToOne(
    () => TgfadrcstEntity,
    (tgfadrcstEntity) => tgfadrcstEntity.tgfadrcstr113,
    {
      onDelete: 'CASCADE',
    },
  )
  ...
  @ManyToOne(() => TgfproEntity, (tgfproEntity) => tgfproEntity.tgfadrcstr113)
  @JoinColumn([{ name: 'COD_ITEM', referencedColumnName: 'codprod' }])
  codItem2: TgfproEntity;

  @ManyToOne(() => TgfempEntity, (tgfempEntity) => tgfempEntity.tgfadrcstr113)
