...
@Entity('TGFADRCSTR1510', { schema: 'SANKHYA' })
export class Tgfadrcstr1510Entity {
  ...
  @ManyToOne(
    () => TgfadrcstEntity,
    (tgfadrcstEntity) => tgfadrcstEntity.tgfadrcstr116,
    {
      onDelete: 'CASCADE',
    },
  )
  ...
  @ManyToOne(() => TgfempEntity, (tgfempEntity) => tgfempEntity.tgfadrcstr116)
  @JoinColumn([{ name: 'CODEMP', referencedColumnName: 'codemp' }])
  codemp2: TgfempEntity;

  @ManyToOne(() => TgfproEntity, (tgfproEntity) => tgfproEntity.tgfadrcstr116)
