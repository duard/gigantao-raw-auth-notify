...
@Index('PK_TGFDIMESCR26', ['codemp', 'dtref', 'reg', 'tpitem', 'digitado'], {
  unique: true,
})
@Entity('TGFDIMESCR26', { schema: 'SANKHYA' })
export class Tgfdimescr26Entity {
  ...
  @ManyToOne(
    () => TgfdimescEntity,
    (tgfdimescEntity) => tgfdimescEntity.tgfdimescrs5,
  )
  @JoinColumn([
