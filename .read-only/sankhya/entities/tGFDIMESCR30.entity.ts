...
@Index('PK_TGFDIMESCR30', ['codemp', 'dtref', 'reg', 'tpitem'], {
  unique: true,
})
@Entity('TGFDIMESCR30', { schema: 'SANKHYA' })
export class Tgfdimescr30Entity {
  ...
  @ManyToOne(
    () => TgfdimescEntity,
    (tgfdimescEntity) => tgfdimescEntity.tgfdimescrs6,
  )
  @JoinColumn([
