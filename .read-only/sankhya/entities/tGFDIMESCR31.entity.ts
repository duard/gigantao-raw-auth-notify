...
@Index('PK_TGFDIMESCR31', ['codemp', 'dtref', 'reg', 'tpitem'], {
  unique: true,
})
@Entity('TGFDIMESCR31', { schema: 'SANKHYA' })
export class Tgfdimescr31Entity {
  ...
  @ManyToOne(
    () => TgfdimescEntity,
    (tgfdimescEntity) => tgfdimescEntity.tgfdimescrs7,
  )
  @JoinColumn([
