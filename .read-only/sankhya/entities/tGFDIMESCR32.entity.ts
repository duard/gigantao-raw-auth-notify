...
@Index('PK_TGFDIMESCR32', ['codemp', 'dtref', 'reg', 'tpitem'], {
  unique: true,
})
@Entity('TGFDIMESCR32', { schema: 'SANKHYA' })
export class Tgfdimescr32Entity {
  ...
  @ManyToOne(
    () => TgfdimescEntity,
    (tgfdimescEntity) => tgfdimescEntity.tgfdimescrs8,
  )
  @JoinColumn([
