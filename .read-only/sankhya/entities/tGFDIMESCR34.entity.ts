...
@Index('PK_TGFDIMESCR34', ['codemp', 'dtref', 'reg', 'tpitem'], {
  unique: true,
})
@Entity('TGFDIMESCR34', { schema: 'SANKHYA' })
export class Tgfdimescr34Entity {
  ...
  @ManyToOne(
    () => TgfdimescEntity,
    (tgfdimescEntity) => tgfdimescEntity.tgfdimescr10,
  )
  @JoinColumn([
