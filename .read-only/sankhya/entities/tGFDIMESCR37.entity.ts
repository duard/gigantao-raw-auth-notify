...
@Index('PK_TGFDIMESCR37', ['codemp', 'dtref', 'reg', 'tpitem'], {
  unique: true,
})
@Entity('TGFDIMESCR37', { schema: 'SANKHYA' })
export class Tgfdimescr37Entity {
  ...
  @ManyToOne(
    () => TgfdimescEntity,
    (tgfdimescEntity) => tgfdimescEntity.tgfdimescr13,
  )
  @JoinColumn([
