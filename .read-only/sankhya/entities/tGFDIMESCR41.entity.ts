...
@Index('PK_TGFDIMESCR41', ['codemp', 'dtref', 'reg', 'tpitem'], {
  unique: true,
})
@Entity('TGFDIMESCR41', { schema: 'SANKHYA' })
export class Tgfdimescr41Entity {
  ...
  @ManyToOne(
    () => TgfdimescEntity,
    (tgfdimescEntity) => tgfdimescEntity.tgfdimescr14,
  )
  @JoinColumn([
