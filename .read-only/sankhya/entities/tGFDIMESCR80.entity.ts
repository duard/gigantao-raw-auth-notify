...
@Index('PK_TGFDIMESCR80', ['codemp', 'dtref', 'reg', 'tpitem'], {
  unique: true,
})
@Entity('TGFDIMESCR80', { schema: 'SANKHYA' })
export class Tgfdimescr80Entity {
  ...
  @ManyToOne(
    () => TgfdimescEntity,
    (tgfdimescEntity) => tgfdimescEntity.tgfdimescr22,
  )
  @JoinColumn([
