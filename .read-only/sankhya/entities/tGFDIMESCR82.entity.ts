...
@Index('PK_TGFDIMESCR82', ['codemp', 'dtref', 'reg', 'tpitem'], {
  unique: true,
})
@Entity('TGFDIMESCR82', { schema: 'SANKHYA' })
export class Tgfdimescr82Entity {
  ...
  @ManyToOne(
    () => TgfdimescEntity,
    (tgfdimescEntity) => tgfdimescEntity.tgfdimescr24,
  )
  @JoinColumn([
