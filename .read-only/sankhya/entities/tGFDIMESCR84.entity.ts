...
@Index('PK_TGFDIMESCR84', ['codemp', 'dtref', 'reg', 'tpitem'], {
  unique: true,
})
@Entity('TGFDIMESCR84', { schema: 'SANKHYA' })
export class Tgfdimescr84Entity {
  ...
  @ManyToOne(
    () => TgfdimescEntity,
    (tgfdimescEntity) => tgfdimescEntity.tgfdimescr26,
  )
  @JoinColumn([
