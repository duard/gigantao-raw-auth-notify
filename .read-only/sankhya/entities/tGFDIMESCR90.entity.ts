...
@Index('PK_TGFDIMESCR90', ['codemp', 'dtref', 'reg', 'tpitem'], {
  unique: true,
})
@Entity('TGFDIMESCR90', { schema: 'SANKHYA' })
export class Tgfdimescr90Entity {
  ...
  @ManyToOne(
    () => TgfdimescEntity,
    (tgfdimescEntity) => tgfdimescEntity.tgfdimescr28,
  )
  @JoinColumn([
