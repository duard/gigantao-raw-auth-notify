...
@Index('PK_TGFDIMESCR91', ['codemp', 'dtref', 'reg', 'tpitem'], {
  unique: true,
})
@Entity('TGFDIMESCR91', { schema: 'SANKHYA' })
export class Tgfdimescr91Entity {
  ...
  @ManyToOne(
    () => TgfdimescEntity,
    (tgfdimescEntity) => tgfdimescEntity.tgfdimescr29,
  )
  @JoinColumn([
