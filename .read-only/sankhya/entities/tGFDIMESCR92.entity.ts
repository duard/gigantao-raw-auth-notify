...
@Index('PK_TGFDIMESCR92', ['codemp', 'dtref', 'reg', 'tpitem'], {
  unique: true,
})
@Entity('TGFDIMESCR92', { schema: 'SANKHYA' })
export class Tgfdimescr92Entity {
  ...
  @ManyToOne(
    () => TgfdimescEntity,
    (tgfdimescEntity) => tgfdimescEntity.tgfdimescr30,
  )
  @JoinColumn([
