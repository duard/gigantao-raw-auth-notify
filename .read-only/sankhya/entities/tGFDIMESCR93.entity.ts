...
@Index('PK_TGFDIMESCR93', ['codemp', 'dtref', 'reg', 'tpitem'], {
  unique: true,
})
@Entity('TGFDIMESCR93', { schema: 'SANKHYA' })
export class Tgfdimescr93Entity {
  ...
  @ManyToOne(
    () => TgfdimescEntity,
    (tgfdimescEntity) => tgfdimescEntity.tgfdimescr31,
  )
  @JoinColumn([
