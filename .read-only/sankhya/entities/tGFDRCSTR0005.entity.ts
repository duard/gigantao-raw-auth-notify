...
@Index('PK_TGFDRCSTR0005', ['codemp', 'dtinicial', 'dtfinal', 'reg'], {
  unique: true,
})
@Entity('TGFDRCSTR0005', { schema: 'SANKHYA' })
export class Tgfdrcstr0005Entity {
  ...
  @Column('varchar', { name: 'COMPL', nullable: true, length: 10 })
  compl: string | null;
  ...
  @ManyToOne(
    () => TgfdrcstEntity,
    (tgfdrcstEntity) => tgfdrcstEntity.tgfdrcstr0s3,
    {
      onDelete: 'CASCADE',
    },
  )
