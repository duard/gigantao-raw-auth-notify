...
@Index('PK_TGFDRCSTR2990', ['codemp', 'dtinicial', 'dtfinal', 'reg'], {
  unique: true,
})
@Entity('TGFDRCSTR2990', { schema: 'SANKHYA' })
export class Tgfdrcstr2990Entity {
  ...
  @ManyToOne(
    () => TgfdrcstEntity,
    (tgfdrcstEntity) => tgfdrcstEntity.tgfdrcstr2s3,
    {
      onDelete: 'CASCADE',
    },
  )
