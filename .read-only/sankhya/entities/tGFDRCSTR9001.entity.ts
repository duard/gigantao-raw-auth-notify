...
@Index('PK_TGFDRCSTR9001', ['codemp', 'dtinicial', 'dtfinal', 'reg'], {
  unique: true,
})
@Entity('TGFDRCSTR9001', { schema: 'SANKHYA' })
export class Tgfdrcstr9001Entity {
  ...
  @ManyToOne(
    () => TgfdrcstEntity,
    (tgfdrcstEntity) => tgfdrcstEntity.tgfdrcstr9s,
    {
      onDelete: 'CASCADE',
    },
  )
