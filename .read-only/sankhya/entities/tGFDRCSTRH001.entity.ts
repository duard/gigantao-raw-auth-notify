...
@Index('PK_TGFDRCSTRH001', ['codemp', 'dtinicial', 'dtfinal', 'reg'], {
  unique: true,
})
@Entity('TGFDRCSTRH001', { schema: 'SANKHYA' })
export class Tgfdrcstrh001Entity {
  ...
  @ManyToOne(
    () => TgfdrcstEntity,
    (tgfdrcstEntity) => tgfdrcstEntity.tgfdrcstrhs,
    {
      onDelete: 'CASCADE',
    },
  )
