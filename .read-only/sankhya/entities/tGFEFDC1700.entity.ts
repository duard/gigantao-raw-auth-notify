...
@Index('PK_TGFEFDC1700', ['codemp', 'dtref', 'regniv1', 'indNatRet'], {
  unique: true,
})
@Entity('TGFEFDC1700', { schema: 'SANKHYA' })
export class Tgfefdc1700Entity {
  ...
  @Column('varchar', { name: 'REGISTRO', length: 4, default: () => "'1700'" })
  registro: string;
