...
@Entity('TGFEFDCC191', { schema: 'SANKHYA' })
export class Tgfefdcc191Entity {
  ...
  @Column('varchar', { name: 'REGISTRO', length: 4, default: () => "'C191'" })
  registro: string;

  @Column('varchar', { name: 'CNPJ_CPF_PART', nullable: true, length: 14 })
  cnpjCpfPart: string | null;
