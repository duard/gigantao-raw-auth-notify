...
@Index(
  'PK_TGFEFDCC605',
  ['codemp', 'dtref', 'regniv1', 'codempestab', 'seqc600', 'sequencia'],
  {
    unique: true,
  },
)
@Entity('TGFEFDCC605', { schema: 'SANKHYA' })
export class Tgfefdcc605Entity {
  ...
  @Column('varchar', { name: 'REGISTRO', length: 4, default: () => "'C605'" })
  registro: string;
