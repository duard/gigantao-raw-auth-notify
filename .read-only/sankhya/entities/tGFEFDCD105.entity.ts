...
@Entity('TGFEFDCD105', { schema: 'SANKHYA' })
export class Tgfefdcd105Entity {
  ...
  @Column('varchar', { name: 'REGISTRO', length: 4, default: () => "'D105'" })
  registro: string;

  @Column('varchar', { name: 'IND_NAT_FRT', nullable: true, length: 1 })
