...
@Entity('TGFEFDCF120', { schema: 'SANKHYA' })
export class Tgfefdcf120Entity {
  ...
  @Column('varchar', { name: 'REGISTRO', length: 4, default: () => "'F120'" })
  registro: string;
  ...
  @Column('float', { name: 'VL_OPER_DEP', nullable: true, precision: 53 })
  vlOperDep: number | null;
