...
@Entity('TGFEFDCF510', { schema: 'SANKHYA' })
export class Tgfefdcf510Entity {
  ...
  @Column('varchar', { name: 'REGISTRO', length: 4, default: () => "'F510'" })
  registro: string;

  @Column('float', { name: 'VL_REC_CAIXA', nullable: true, precision: 53 })
  vlRecCaixa: number | null;
