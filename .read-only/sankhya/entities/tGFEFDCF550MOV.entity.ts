...
@Index(
  'PK_TGFEFDCF550MOV',
  ['chave', 'dtref', 'codemp', 'codempestab', 'regniv1', 'nufin'],
  {
    unique: true,
  },
)
@Entity('TGFEFDCF550MOV', { schema: 'SANKHYA' })
export class Tgfefdcf550MovEntity {
  ...
  @Column('varchar', { primary: true, name: 'REGNIV1', length: 5 })
  regniv1: string;

  @Column('varchar', { name: 'REG', length: 5 })
  reg: string;
