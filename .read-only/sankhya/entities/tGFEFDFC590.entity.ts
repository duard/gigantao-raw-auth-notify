...
@Index('PK_TGFEFDFC590', ['codemp', 'dtref', 'regniv1', 'chave', 'sequencia'], {
  unique: true,
})
@Entity('TGFEFDFC590', { schema: 'SANKHYA' })
export class Tgfefdfc590Entity {
  ...
  @Column('varchar', { name: 'REGISTRO', length: 4, default: () => "'C590'" })
  registro: string;
