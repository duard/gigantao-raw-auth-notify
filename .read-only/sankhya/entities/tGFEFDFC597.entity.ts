...
@Index(
  'PK_TGFEFDFC597',
  ['codemp', 'dtref', 'regniv1', 'chave', 'seqc595', 'sequencia'],
  {
    unique: true,
  },
)
@Entity('TGFEFDFC597', { schema: 'SANKHYA' })
export class Tgfefdfc597Entity {
  ...
  @Column('int', { primary: true, name: 'SEQC595' })
  seqc595: number;
  ...
  @Column('varchar', { name: 'REGISTRO', length: 4, default: () => "'C597'" })
  registro: string;
