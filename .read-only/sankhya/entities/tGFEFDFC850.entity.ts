...
@Index('PK_TGFEFDFC850', ['codemp', 'dtref', 'regniv1', 'chave', 'sequencia'], {
  unique: true,
})
@Entity('TGFEFDFC850', { schema: 'SANKHYA' })
export class Tgfefdfc850Entity {
  ...
  @Column('varchar', { name: 'REGISTRO', length: 4, default: () => "'C850'" })
  registro: string;
