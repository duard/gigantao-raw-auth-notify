...
@Index('PK_TGFEFDFC890', ['codemp', 'dtref', 'regniv1', 'chave', 'sequencia'], {
  unique: true,
})
@Entity('TGFEFDFC890', { schema: 'SANKHYA' })
export class Tgfefdfc890Entity {
  ...
  @Column('varchar', { name: 'REGISTRO', length: 4, default: () => "'C890'" })
  registro: string;
