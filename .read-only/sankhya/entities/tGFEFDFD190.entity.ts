...
@Index('PK_TGFEFDFD190', ['codemp', 'dtref', 'regniv1', 'chave', 'sequencia'], {
  unique: true,
})
@Entity('TGFEFDFD190', { schema: 'SANKHYA' })
export class Tgfefdfd190Entity {
  ...
  @Column('varchar', { name: 'REGISTRO', length: 4, default: () => "'D190'" })
  registro: string;
