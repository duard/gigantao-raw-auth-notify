...
@Index('PK_TGFEFDFD500', ['codemp', 'dtref', 'regniv1', 'chave'], {
  unique: true,
})
@Entity('TGFEFDFD500', { schema: 'SANKHYA' })
export class Tgfefdfd500Entity {
  ...
  @Column('smallint', { name: 'TP_ASSINANTE', nullable: true })
