...
@Index('PK_TGFEFDFD590', ['codemp', 'dtref', 'regniv1', 'chave', 'sequencia'], {
  unique: true,
})
@Entity('TGFEFDFD590', { schema: 'SANKHYA' })
export class Tgfefdfd590Entity {
  ...
  @Column('varchar', { name: 'REGISTRO', length: 4, default: () => "'D590'" })
  registro: string;
  ...
  @Column('int', { name: 'COD_OBS', nullable: true })
  codObs: number | null;
