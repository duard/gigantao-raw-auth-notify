...
@Index(
  'PK_TRIAQPR',
  ['codemp', 'dtref', 'tpamb', 'sequencia', 'chave', 'nrinscprod'],
  {
    unique: true,
  },
)
@Entity('TRIAQPR', { schema: 'SANKHYA' })
export class TriaqprEntity {
  ...
  @Column('varchar', { primary: true, name: 'NRINSCPROD', length: 14 })
  nrinscprod: string;
  ...
  @ManyToOne(() => TricabEntity, (tricabEntity) => tricabEntity.triaqprs)
  @JoinColumn([
