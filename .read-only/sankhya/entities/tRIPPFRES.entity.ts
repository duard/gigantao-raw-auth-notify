...
@Index(
  'PK_TRIPPFRES',
  ['codemp', 'dtref', 'tpamb', 'sequencia', 'natrend', 'cpfbenef'],
  {
    unique: true,
  },
)
@Entity('TRIPPFRES', { schema: 'SANKHYA' })
export class TrippfresEntity {
  ...
  @Column('varchar', { primary: true, name: 'CPFBENEF', length: 14 })
  cpfbenef: string;
  ...
  @ManyToOne(() => TriresEntity, (triresEntity) => triresEntity.trippfres, {
    onDelete: 'CASCADE',
  })
  @JoinColumn([
