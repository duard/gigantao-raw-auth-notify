...
@Index('PK_TRIREAD', ['codemp', 'dtref', 'tpamb', 'sequencia', 'chave'], {
  unique: true,
})
@Entity('TRIREAD', { schema: 'SANKHYA' })
export class TrireadEntity {
  ...
  @ManyToOne(() => TricabEntity, (tricabEntity) => tricabEntity.trireads)
  @JoinColumn([
