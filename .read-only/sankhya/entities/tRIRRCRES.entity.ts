...
@Index(
  'PK_TRIRRCRES',
  ['codemp', 'dtref', 'tpamb', 'sequencia', 'natrend', 'cnpjfont'],
  {
    unique: true,
  },
)
@Entity('TRIRRCRES', { schema: 'SANKHYA' })
export class TrirrcresEntity {
  ...
  @Column('varchar', { primary: true, name: 'CNPJFONT', length: 14 })
  cnpjfont: string;
  ...
  @ManyToOne(() => TriresEntity, (triresEntity) => triresEntity.trirrcres, {
    onDelete: 'CASCADE',
  })
  @JoinColumn([
