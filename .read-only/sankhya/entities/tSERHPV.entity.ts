...
@Index('PK_TSERHPV', ['nuconsulta', 'sequencia'], { unique: true })
@Entity('TSERHPV', { schema: 'SANKHYA' })
export class TserhpvEntity {
  ...
  @Column('varchar', { name: 'DESCR7', nullable: true, length: 20 })
  descr7: string | null;

  @Column('float', { name: 'VALOR7', nullable: true, precision: 53 })
  valor7: number | null;

  @Column('int', { name: 'PERC7', nullable: true })
  perc7: number | null;
