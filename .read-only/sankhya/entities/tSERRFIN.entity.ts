...
@Index('PK_TSERRFIN', ['nuconsulta', 'sequencia'], { unique: true })
@Entity('TSERRFIN', { schema: 'SANKHYA' })
export class TserrfinEntity {
  @Column('int', { primary: true, name: 'NUCONSULTA' })
  nuconsulta: number;

  @Column('smallint', { name: 'QTDREFERENCIA', nullable: true })
  qtdreferencia: number | null;
