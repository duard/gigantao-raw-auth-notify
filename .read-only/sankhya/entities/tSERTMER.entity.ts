...
@Index('PK_TSERTMER', ['nuconsulta', 'sequencia'], { unique: true })
@Entity('TSERTMER', { schema: 'SANKHYA' })
export class TsertmerEntity {
  ...
  @Column('varchar', { name: 'PERCMEDFAIXA', nullable: true, length: 20 })
  percmedfaixa: string | null;
}
