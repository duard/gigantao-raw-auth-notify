...
import { TsipaiEntity } from 'src/sankhya/entities/tSIPAI.entity';
import { TgftitEntity } from 'src/sankhya/entities/tGFTIT.entity';
import { TgfparEntity } from 'src/sankhya/entities/tGFPAR.entity';

export class CreateTsiufsDto {
  @ApiProperty()
  coduf: number;
